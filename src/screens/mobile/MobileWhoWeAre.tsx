...
export function MobileWhoWeAre() {
    return (
        <div className="flex gap-4 flex-col px-10 py-12 md:py-24 md:px-20 w-screen justify-center text-center" id="mobileWhoWeAre">
            ...
            <div className="flex pt-20 mx-8 basis-1/3 bg-[url('assets/retangle-1.png')] bg-bottom bg-contain bg-no-repeat mt-[-40px] md:px-44 md:mt-20">
